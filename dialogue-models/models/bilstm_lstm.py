...
class MyBaseModel(nn.Module, BaseModel):
    def __init__(self, padding_idx: int = -1, **kwargs):
        ...
        self.lstm = nn.LSTM(self.embedding_dim, 128, batch_first=True, bidirectional=True)
...
if __name__ == '__main__':
    ...
    glove_obj = GloVe(name='6B', dim=300)
    ...
    train_dataloader = data_prep('train', 'dialogue', batch_size=256, shuffle=True)
    test_dataloader = data_prep('validation', 'dialogue', batch_size=256, shuffle=True)
