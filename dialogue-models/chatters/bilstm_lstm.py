...
if __name__ == '__main__':
    ...
    bilstm_chatter = BiLSTMChatter(encoder_model_path='../saved models/bilstm_lstm-models/encoder_model8.pt',
                                   decoder_model_path='../saved models/bilstm_lstm-models/decoder_model8.pt',
                                   tokenizer_path= '../saved models/bilstm_lstm-models/bilstm_tokenizer.pth')
