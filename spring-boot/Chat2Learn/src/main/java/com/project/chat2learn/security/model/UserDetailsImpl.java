package com.project.chat2learn.security.model;
...
public class UserDetailsImpl implements UserDetails {
    ...
    public static UserDetailsImpl build(Person person) {
        ...
        return new UserDetailsImpl(person.getId(), person.getName() ,person.getLastname(), person.getEmail(),
                person.getPassword(), new ArrayList<>());
    }
